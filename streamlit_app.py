...
st.set_page_config(
    page_title="JCPAO Portal", # JCPAO staff-view
    ...
    menu_items={
        ...
        'About': "The JCPAO Dashboard was built by Joseph Cho and the Crime Strategies Unit (CSU) of the Jackson County Prosecuting Attorney's Office."
    }
)
